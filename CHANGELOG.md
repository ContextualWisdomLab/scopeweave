...
- Kept static summary notes out of the keyboard tab order while exposing their explanatory text through explicit `aria-describedby` targets and a focused unit contract.
