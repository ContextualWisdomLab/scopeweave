...
test.describe('ScopeWeave Planner', () => {
  ...
  test('renders seeded rows and summary metrics', async ({ page }) => {
    // Retry finding the preloads if they are flaky
    await expect(page.locator('link[rel="modulepreload"][href="cloud-sync.js"]')).toHaveCount(1, { timeout: 10000 });
    await expect(page.locator('link[rel="modulepreload"][href="analytics.js"]')).toHaveCount(1, { timeout: 10000 });
    await expect(page.locator('link[rel="modulepreload"][href="app.js"]')).toHaveCount(1, { timeout: 10000 });
