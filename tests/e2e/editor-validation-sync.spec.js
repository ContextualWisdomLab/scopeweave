...
test('invalid save stays focusable and programmatically described', async ({ page }) => {
  await page.goto('./');
  ...
  // Native form validation may move focus to the first invalid required field.
