...
function computeTaskMetrics() {
  // ⚡ Bolt: Replace Map with Int32Array and Array methods with for loops to eliminate JS engine callback allocation, garbage collection, and hash-lookup overhead
