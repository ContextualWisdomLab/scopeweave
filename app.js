...
function computeTaskMetrics() {
  // ⚡ Bolt: Use standard for loop to avoid callback allocation while preserving Map overhead
  ...
  // Preserve Map keyed by task.id to maintain original overwrite semantics
