...
// ⚡ Bolt: Use inline ternary operations instead of String.padStart() to avoid unnecessary string allocations and JS-to-C++ overhead in date formatting hot loops.
