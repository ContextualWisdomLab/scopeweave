...
// ⚡ Bolt: Use inline ternary string concatenation instead of String.padStart()
// in hot loops (e.g. date formatters) to avoid unnecessary string allocations and JS-to-C++ overhead.
