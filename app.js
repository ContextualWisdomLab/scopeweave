...
function computeTaskMetrics() {
  ...
  // ⚡ Bolt: Replace Map and reduce/forEach with Int32Array and standard for loops to eliminate JS engine allocation and hash lookup overhead
  const tasksCount = state.tasks.length;
  const durationCache = new Int32Array(tasksCount);
  let totalDays = 0;
