...
function createTextCellContent(value, warning = '') {
  ...
  if (!textCellWrapperTemplate) {
    ...
    validationMessageTemplate = document.createElement('div');
    validationMessageTemplate.className = 'validation-message';
  }
  const wrapper = textCellWrapperTemplate.cloneNode(false);
  wrapper.appendChild(document.createTextNode(value));
  const validation = validationMessageTemplate.cloneNode(false);
