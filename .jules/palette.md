...
## 2026-08-13 - Accessible Tooltips for Non-interactive Elements
**Learning:** Tooltips via title or aria-label on non-interactive elements (like span or div) are inaccessible to keyboard users unless they receive focus. Using tabindex="0" without a valid ARIA role is an anti-pattern.
**Action:** Add tabindex="0" alongside a semantic role (e.g. role="note" or role="region") and ensure :focus-visible states exist.
