...
## 2026-07-31 - [UX: Add beforeunload warning for unsaved changes]
**Learning:** Users can accidentally lose input data if they refresh or close the tab while editing a task.
**Action:** Add a window.addEventListener('beforeunload') handler in bindGlobalEvents to warn users if state.editor has unsaved draft changes compared to initialDraft.
