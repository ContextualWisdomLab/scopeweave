...
## 2026-08-08 - Add Confirmation Dialog for CSV Import
...
## 2026-08-08 - Prevent accidental data loss in inline editors
...
## 2026-08-08 - Replace native disabled with aria-disabled for save button
**Learning:** Native `disabled` attributes on submit buttons prevent keyboard focus and block click events, making it difficult for keyboard and screen reader users to understand why a form cannot be saved.
**Action:** Use `aria-disabled="true"` instead of `disabled` for the inline editor save button.
