...
/**
 * Append an audit event while preserving nullable actor/target metadata.
 *
 * Audit recording is deliberately best-effort: a storage failure must not fail
 * the customer request that produced the event.
 */
export function logAudit(orgId, userId, action, targetType, targetId, meta) {
  try {
