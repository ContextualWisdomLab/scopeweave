...
app.post('/api/auth/login', async (c) => {
  ...
  // Sentinel: Prevent user enumeration timing attack on unauthenticated login route.
  // Evaluate verifyPassword unconditionally using a dynamic dummy hash if user not found.
  // We explicitly coerce the candidate password to a string to prevent TypeErrors.
