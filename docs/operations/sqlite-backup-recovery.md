...
8. Publish the verified inode without overwriting an existing destination and retain owner-only permissions.
9. Remove incomplete temporary state best-effort if any earlier step fails.
